...
const uint32_t HLW_PREF_PULSE = 9049;       // Kogan KASPEMHA 
const uint32_t HLW_UREF_PULSE = 1602;       // was 1666us = 600Hz = 220V
const uint32_t HLW_IREF_PULSE = 3163;       // was 1666us = 600Hz = 4.545A
